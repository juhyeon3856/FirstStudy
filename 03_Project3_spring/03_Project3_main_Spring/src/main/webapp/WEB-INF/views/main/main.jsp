...
<body>
    ...
    <main>
        ...
        <div class="container">
            <div class="carousel">
                <div class="cell"><a href="#"><img src="/image/개3.jpg" alt="게시판" /></a></div>
                <div class="cell"><a href="#"><img src="/image/다른개.jpg" alt="마이페이지" /></a></div>
                <div class="cell"><a href="#"><img src="/image/개.jpg" alt="login" /></a></div>
            </div>            
        </div>
