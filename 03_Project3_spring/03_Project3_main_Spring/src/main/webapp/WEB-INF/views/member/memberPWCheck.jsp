    ...
    <div class="container">
      <c:choose>
        <c:when test="${isLoggedIn == true}">
       	...
       	<form action="/member/pwCheck?memberId=${userId}" method="post">
        <div class="content">
            <div class="content__list">
                ...
                <div class="reg-line">
                   <label>아이디 </label>
                    <input type="text" value="${userId}" name="memberId" disabled>
                </div>
                <div class="reg-line">
                    <label>비밀번호</label>
                ...
                <input type="button" class="btn" value="취소" onclick="window.location.href='/member/main?memberId=${userId}';">
                </div>
            </div>
        </div>
        </form>
