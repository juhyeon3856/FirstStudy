...
<body>
    ...
    <div class="container">
      <c:choose>
        ...
        <div class="content">
            <form action="/member/searchIDPW" method="post" class="search" name="formID" target="_blank">
                <div class="title">
                    <h2>아이디 찾기</h2>
                </div>
                <div class="feild">
                    <input type="text" placeholder=" 이름을 입력하세요." name="memberName">                    
                    <input type="text" placeholder=" 전화번호를 입력하세요." name="memberPhoneNum">
            ...
            <form action="/member/searchIDPW" method="post" class="search" name="formPW" target="_blank">
                <div class="title">
                    <h2>비밀번호 찾기</h2>
                </div>
                <div class="feild">
        ...
        <div class="reg-btnnn">
         <input type="button" value="로그인" onclick="window.location.href='/member'">
